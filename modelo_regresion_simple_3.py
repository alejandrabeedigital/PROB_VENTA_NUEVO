...
ARCHIVO_OUT = "todo_con_resultados_3.csv"
TARGET = "ganada"
...
# =========================
# Añadimos:
# - median_income_equiv como numérica
# - habitat como categórica
features_num = ["q_rk_score", "origen_sc_o_no", "median_income_equiv"]
