...
ARCHIVO_OUT = "ventas_con_segmentacion_autonomo_qrk_origen_forzado_habitat_income_presvirt_movil_vars_nuevas.csv"
...
def main():
    ...
    # -------------------------
    needed = ["excliente", "dias_desde_ult_cont", "ranking_number", "claim_business", "website_x", "website_y"]
    ...
    website = df["website_x"].combine_first(df["website_y"])
